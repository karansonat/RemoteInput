...
namespace MalbersAnimations
{
    ...
    public class AnimalEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            controller = (UnityEditor.Animations.AnimatorController)M.Anim.runtimeAnimatorController;
        ...
        protected void DrawAnimalInspector()
        {
            ...
            if (M.EditorEvents)
            {
                ...
                if (M.canFly) EditorGUILayout.PropertyField(serializedObject.FindProperty("OnFly"), new GUIContent("On Fly"));
                if (M.canSwim) EditorGUILayout.PropertyField(serializedObject.FindProperty("OnSwim"), new GUIContent("On Swim"));
            }
